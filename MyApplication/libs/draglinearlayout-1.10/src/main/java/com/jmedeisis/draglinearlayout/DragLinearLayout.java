...
public class DragLinearLayout extends LinearLayout {
    //TODO: fix item disappear when leaving current layout
    ...
    private void onDrag(final int offset) {
        ...
        if (isBelow || isAbove) {
            ...
            if (null != onDragEventListener) {
                onDragEventListener.onSwap(draggedItem.view, draggedItem.position, switchView, switchPosition);
            }
    ...
    /**
     * Use with {@link com.jmedeisis.draglinearlayout.DragLinearLayout#setOnDragEventListener(OnDragEventListener)}
    ...
    private class DragItem {
        ...
        public void onDragStart() {
            ...
            if (onDragEventListener != null) {
                onDragEventListener.onDragStart(view);
            }
        }
